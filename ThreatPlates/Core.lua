-- Nombre real de la carpeta, tal y como lo pasa el cargador de addons.
-- Estaba escrito a mano como "TidyPlates" mas abajo; al renombrar el addon
-- esa comparacion dejaba de cumplirse y este archivo no registraba nada.
local ADDON_NAME = ...

TidyPlatesThreat = LibStub("AceAddon-3.0"):NewAddon("TidyPlatesThreat", "AceConsole-3.0", "AceEvent-3.0")

-- Nombre que ve el usuario, en un solo sitio.
-- Estaba repetido a mano ("Tidy Plates") en el titulo de la ventana, en los
-- avisos por chat, en el tooltip del minimapa y en la categoria de Interfaz.
-- Al renombrar el addon eso no solo quedaba feo: la llamada que abre la
-- categoria de Interfaz busca por ese texto, asi que dejaba de encontrarla.
TidyPlatesThreat.DISPLAY_NAME = "|cffffffffNidhaus|r|cff00ff00_Plates|r"
...
function TidyPlatesThreat:ProfChange()
	...
	if TidyPlatesThreat.RebuildUniqueList then
		TidyPlatesThreat.RebuildUniqueList()
	end
...
function TidyPlatesThreat:OnInitialize()
	local defaults = {
		char = {
			...
			threat = {tanking = false},
			spec = {primary = false, secondary = false},
		...
		profile = {
			...
			uniqueSettings = {
				...
				[1] = {
					...
					overrideScale = false,
					overrideAlpha = false,
					icon = "Interface\\Addons\\Nidhaus_Plates\\ThreatPlates\\Widgets\\UniqueIconWidget\\U1",
					scale = 0.45,
					alpha = 1,
				...
				[2] = {
					...
					overrideScale = false,
					overrideAlpha = false,
					icon = "Interface\\Addons\\Nidhaus_Plates\\ThreatPlates\\Widgets\\UniqueIconWidget\\U2",
					scale = 0.45,
					alpha = 1,
				...
				[3] = {
					...
					overrideScale = false,
					overrideAlpha = false,
					icon = "Interface\\Addons\\Nidhaus_Plates\\ThreatPlates\\Widgets\\UniqueIconWidget\\U3",
					scale = 0.45,
					alpha = 1,
				...
				[4] = {
					...
					overrideScale = false,
					overrideAlpha = false,
					icon = "Interface\\Addons\\Nidhaus_Plates\\ThreatPlates\\Widgets\\UniqueIconWidget\\U4",
					scale = 0.45,
					alpha = 1,
				...
				[5] = {
					...
					overrideScale = false,
					overrideAlpha = false,
					icon = "Interface\\Addons\\Nidhaus_Plates\\ThreatPlates\\Widgets\\UniqueIconWidget\\U5",
					scale = 0.45,
					alpha = 1,
					color = {r = 1, g = 0.71, b = 0}
				},
				[6] = {
					...
					overrideScale = false,
					overrideAlpha = false,
					icon = "Interface\\Addons\\Nidhaus_Plates\\ThreatPlates\\Widgets\\UniqueIconWidget\\U6",
					scale = 0.45,
					alpha = 1,
					color = {
						r = 0.39,
				...
				[8] = {
					...
					overrideScale = false,
					overrideAlpha = false,
					icon = "Interface\\Addons\\Nidhaus_Plates\\ThreatPlates\\Widgets\\UniqueIconWidget\\U7",
					scale = 0.45,
					alpha = 1,
				...
				[9] = {
					...
					overrideScale = false,
					overrideAlpha = false,
					icon = "Interface\\Addons\\Nidhaus_Plates\\ThreatPlates\\Widgets\\UniqueIconWidget\\U8",
					scale = 1,
					alpha = 1,
				...
				[10] = {
					...
					overrideScale = false,
					overrideAlpha = false,
					icon = "Interface\\Addons\\Nidhaus_Plates\\ThreatPlates\\Widgets\\UniqueIconWidget\\U9",
					scale = 1,
					alpha = 1,
				...
				[11] = {
					...
					overrideScale = false,
					overrideAlpha = false,
					icon = "Interface\\Addons\\Nidhaus_Plates\\ThreatPlates\\Widgets\\UniqueIconWidget\\U10",
					scale = 0.75,
					alpha = 1,
				...
				[12] = {
					...
					overrideScale = false,
					overrideAlpha = false,
					icon = "Interface\\Addons\\Nidhaus_Plates\\ThreatPlates\\Widgets\\UniqueIconWidget\\U11",
					scale = 1,
					alpha = 1,
				...
				[13] = {
					...
					overrideScale = false,
					overrideAlpha = false,
					icon = "Interface\\Addons\\Nidhaus_Plates\\ThreatPlates\\Widgets\\UniqueIconWidget\\U12",
					scale = 1,
					alpha = 1,
					color = {r = 0.75, g = 0, b = 0.02}
				},
				[14] = {
					...
					overrideScale = false,
					overrideAlpha = false,
					icon = "Interface\\Addons\\Nidhaus_Plates\\ThreatPlates\\Widgets\\UniqueIconWidget\\U13",
					scale = 1,
					alpha = 1,
				...
				[15] = {
					...
					overrideScale = false,
					overrideAlpha = false,
					icon = "Interface\\Addons\\Nidhaus_Plates\\ThreatPlates\\Widgets\\UniqueIconWidget\\U14",
					scale = 1,
					alpha = 1,
				...
				[16] = {
					...
					overrideScale = false,
					overrideAlpha = false,
					icon = "Interface\\Addons\\Nidhaus_Plates\\ThreatPlates\\Widgets\\UniqueIconWidget\\U15",
					scale = 1,
					alpha = 1,
				...
				[18] = {
					...
					overrideScale = false,
					overrideAlpha = false,
					icon = "Interface\\Addons\\Nidhaus_Plates\\ThreatPlates\\Widgets\\UniqueIconWidget\\U16",
					scale = 1,
					alpha = 1,
					color = {r = 1, g = 1, b = 1}
				},
				[19] = {
					...
					overrideScale = false,
					overrideAlpha = false,
					icon = "Interface\\Addons\\Nidhaus_Plates\\ThreatPlates\\Widgets\\UniqueIconWidget\\U17",
					scale = 1,
					alpha = 1,
				...
				[20] = {
					...
					overrideScale = false,
					overrideAlpha = false,
					icon = "Interface\\Addons\\Nidhaus_Plates\\ThreatPlates\\Widgets\\UniqueIconWidget\\U18",
					scale = 1,
					alpha = 1,
				...
				[21] = {
					...
					overrideScale = false,
					overrideAlpha = false,
					icon = "Interface\\Addons\\Nidhaus_Plates\\ThreatPlates\\Widgets\\UniqueIconWidget\\U19",
					scale = 1,
					alpha = 1,
				...
				[22] = {
					...
					overrideScale = false,
					overrideAlpha = false,
					icon = "Interface\\Addons\\Nidhaus_Plates\\ThreatPlates\\Widgets\\UniqueIconWidget\\U20",
					scale = 1,
					alpha = 1,
				...
				[23] = {
					...
					overrideScale = false,
					overrideAlpha = false,
					icon = "Interface\\Addons\\Nidhaus_Plates\\ThreatPlates\\Widgets\\UniqueIconWidget\\U21",
					scale = 1,
					alpha = 1,
				...
				[24] = {
					...
					overrideScale = false,
					overrideAlpha = false,
					icon = "Interface\\Addons\\Nidhaus_Plates\\ThreatPlates\\Widgets\\UniqueIconWidget\\U22",
					scale = 1,
					alpha = 1,
				...
				[25] = {
					...
					overrideScale = false,
					overrideAlpha = false,
					icon = "Interface\\Addons\\Nidhaus_Plates\\ThreatPlates\\Widgets\\UniqueIconWidget\\U23",
					scale = 1,
					alpha = 1,
				...
				[26] = {
					...
					overrideScale = false,
					overrideAlpha = false,
					icon = "Interface\\Addons\\Nidhaus_Plates\\ThreatPlates\\Widgets\\UniqueIconWidget\\U24",
					scale = 1,
					alpha = 1,
				...
				[27] = {
					...
					overrideScale = false,
					overrideAlpha = false,
					icon = "Interface\\Addons\\Nidhaus_Plates\\ThreatPlates\\Widgets\\UniqueIconWidget\\U25",
					scale = 0.85,
					alpha = 1,
				...
				[28] = {
					...
					overrideScale = false,
					overrideAlpha = false,
					icon = "Interface\\Addons\\Nidhaus_Plates\\ThreatPlates\\Widgets\\UniqueIconWidget\\U27",
					scale = 1,
					alpha = 1,
					color = {r = 0, g = 1, b = 0}
				},
				[29] = {
					...
					overrideScale = false,
					overrideAlpha = false,
					icon = "Interface\\Addons\\Nidhaus_Plates\\ThreatPlates\\Widgets\\UniqueIconWidget\\U28",
					scale = 0.60,
					alpha = 0.75,
			...
			classWidget = {
				...
				-- y anillo en el tema circle; se elige solo.
				border = true,
				borderThickness = 1,
				-- Negro de normal, blanco cuando esa unidad es tu objetivo.
				borderColor = {r = 0, g = 0, b = 0},
				borderColorTarget = {r = 1, g = 1, b = 1}
			},
			targetWidget = {
				ON = true,
				theme = "default",
			...
			-- Numero de arena (1-5) y de grupo (1-4) sobre la placa.
			arenaPartyIDWidget = {
				ON = false,
				showArena = true,
				showParty = true,
	...
	-----------------------------------------------------------------------------
	-- Simplified build: one-time migration.
	-- Existing saved profiles keep their old values, so force the new defaults
	-- once per profile. Bump SIMPLE_LAYOUT_VERSION to re-apply after edits.
	-----------------------------------------------------------------------------
	...
	TidyPlatesThreat.ApplySimpleLayout = function()
		...
		p.simpleLayout = SIMPLE_LAYOUT_VERSION
		p.settings.healthbar.width = 100          -- Healthbar width
		p.settings.frame.y = 15                   -- Placement Offset Y
		p.settings.level.show = false             -- Level Text off
		p.settings.customtext.show = false        -- Health Text off
		p.settings.raidicon.hpColor = false       -- Raid Mark HP Color removed
		p.settings.healthborder.texture = "TP_HealthBarOverlayThin" -- Normal Border = Thin
		p.settings.threatborder.show = false      -- Threat Glow removed
		p.customColor = false                     -- Custom HP Color removed
		p.allowClass = true                       -- Enemy Class Colors on
		p.nameplate.scale["Target"] = 1.1         -- Target scale 110%
		...
		if c then
			c.spec.primary = false
			c.spec.secondary = false
			c.threat.tanking = false
			for _, k in ipairs({"auras", "stances", "shapeshifts", "presences"}) do
				if c[k] then c[k].ON = false end
			end
		end
	end
	TidyPlatesThreat.ApplySimpleLayout()
	...
	-----------------------------------------------------------------------------
	-- Custom Nameplates: la lista de nombres contra la que se compara unit.name
	-- solo se reconstruia dentro de UpdateSpecial() (options.lua), y esa funcion
	-- unicamente corre la PRIMERA vez que se abre la ventana de opciones. En un
	-- perfil nuevo la lista quedaba vacia y las placas personalizadas no hacian
	-- nada hasta abrir /tptp una vez. Ahora se reconstruye al iniciar.
	-----------------------------------------------------------------------------
	TidyPlatesThreat.RebuildUniqueList = function()
		local p = TidyPlatesThreat.db and TidyPlatesThreat.db.profile
		if not p or not p.uniqueSettings then return end
		p.uniqueSettings.list = {}
		for k, v in pairs(p.uniqueSettings) do
			if k ~= "list" and type(v) == "table" and type(v.name) == "string" then
				p.uniqueSettings.list[k] = v.name
			end
		end
	end
	TidyPlatesThreat.RebuildUniqueList()
...
-- Ocultado rapido por nombre.
-- Reemplaza a los plugins de PlatesMaster (of_Purity para las serpientes) sin
-- tener que tocar la pestana Custom Nameplates. Se comprueba antes que nada:
-- devolver "empty" es el estilo que no dibuja placa.
-- OJO CON EL IDIOMA. Esta era la razon de que no ocultara nada.
--
-- unit.name llega YA TRADUCIDO por el cliente. Con el WoW en español las
-- serpientes de la trampa no se llaman "Viper" y "Venomous Snake" sino
-- "Víbora" y "Culebra venenosa", asi que la tabla en ingles no acertaba ni
-- una y salian todas con placa, propias y ajenas.
--
-- Se guardan los nombres de todos los idiomas juntos: dos criaturas
-- distintas no van a compartir nombre entre idiomas, con lo que la union no
...
-- Minusculas + vocales sin tilde, para no depender de como venga escrito.
-- string.lower de Lua 5.1 solo toca ASCII: los bytes UTF-8 de las vocales
-- acentuadas los deja igual, de ahi que haga falta el mapa de arriba.
local function Normalize(name)
	if type(name) ~= "string" then return nil end
	name = string.gsub(name, "[\194-\244][\128-\191]", function(ch)
...
local function AddNames(t, ...)
	for i = 1, select("#", ...) do
		local n = Normalize((select(i, ...)))
		if n then t[n] = true end
	end
end

AddNames(HIDE_SNAKES,
	"Viper",  "Venomous Snake",          -- enUS
	"Vibora", "Culebra venenosa",        -- esES / esMX (visto en el cliente)
	"Serpiente venenosa",                -- variante esMX
	"Vipere", "Serpent venimeux",        -- frFR
	"Giftschlange",                      -- deDE ("Viper" se escribe igual)
	"Cobra venenosa")                    -- ptBR

AddNames(HIDE_MIRROR,
	"Mirror Image",                      -- enUS
	"Imagen especular",                  -- esES / esMX
	"Image miroir",                      -- frFR
	"Spiegelbild")                       -- deDE
...
local function KindOf(name)
	local kind = nameKind[name]
	if kind == nil then
		local n = Normalize(name)
		kind = (n and ((HIDE_SNAKES[n] and "snake") or (HIDE_MIRROR[n] and "mirror"))) or false
		nameKind[name] = kind
	end
	return kind
end
	...
	if not self.db.char.welcome then
		...
		if ((TidyPlatesOptions.primary ~= "Threat Plates") and (TidyPlatesOptions.secondary ~= "Threat Plates")) then
			...
			StaticPopupDialogs["SetToThreatPlates"] = {
				...
				OnAlt = function()
					InterfaceOptionsFrame_OpenToCategory(TidyPlatesThreat.DISPLAY_NAME)
				end,
				OnCancel = function()
