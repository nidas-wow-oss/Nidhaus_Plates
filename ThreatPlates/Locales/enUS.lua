...
L["Stances"] = true
--------------------------------------------------
-- Simplified build: merged Tidy Plates settings --
--------------------------------------------------
...
L["Keeps the combat log from going quiet during long battlegrounds."] = true
L["Scoreboard"] = true
L["Detects a healer by comparing healing against damage on the battleground scoreboard."] = true
L["Healing to Damage Ratio"] = true
L["Healing Threshold"] = true
L["Invert Colors"] = true
L["By default enemies are red and allies are blue."] = true
L["Blizzlike"] = true
L["Minimalist"] = true
L["Left"] = true
L["Top"] = true
...
L["Arena / Party ID"] = true
L["Show Arena / Party ID"] = true
L["Shows the arena number (1-5) or the party number (1-4) on the nameplate."] = true
L["Arena Opponents"] = true
...
L["Icon Border"] = true
L["Draws a border around the class icon. Square on the square themes, a ring on Circle."] = true
L["Border Thickness"] = true
L["Border Color"] = true
L["Border Color (Target)"] = true
L["Color of the border on units that are not your target."] = true
L["Color of the border on your current target."] = true
